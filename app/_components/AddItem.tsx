...
export default function AddItem({onAdd} : { onAdd: () => void }) {
    ...
    return (
        ...
        <form onSubmit={handleSubmit} className="my-4">
            ...
            <button type="submit" className="ml-4 px-4 py-2 bg-blue-500 text-white font-semibold rounded-md shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">
                Add</button>
        </form>
    )
}